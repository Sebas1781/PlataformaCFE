...
export const Dropdown = forwardRef(({ label, options, placeholder = "Seleccione una opción", onSelect, value, className }, ref) => {
  ...
  return (
    <div className="flex flex-col space-y-2">
      {label && <label className="text-sm font-medium text-gray-700 hover:text-emerald-600">{label}</label>}
...
// **Checkbox** con reenvío del evento original:
export const Checkbox = ({ label, name, checked, onChange }) => (
  <div className="flex items-center space-x-3">
    <input
      ...
      name={name}
      type="checkbox"
      checked={checked} // Espera un boolean
      onChange={onChange} 
    ...
    <div className="flex flex-col space-y-3 w-full">
      ...
      <div className="relative w-full">
        ...
        <div className="relative bg-gray-300 h-2 rounded-full">
          <span className="absolute bg-emerald-500 h-2 rounded-full" style={{ width: `${percentage}%` }}></span>
          <span
